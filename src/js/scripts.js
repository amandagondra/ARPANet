document.addEventListener("DOMContentLoaded", function () {
    ...
    // Função para fechar o menu (antes não fechava automático)
    menuLinks.forEach(link => {
        link.addEventListener("click", function (e) {
            // Tira a classe active que mantinha visível depois de ir para alguma referência (ai fecha automaticamente)
